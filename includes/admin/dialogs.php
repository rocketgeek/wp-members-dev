...
function wpmem_a_do_warnings( $did_update ) {
	...
	if ( $did_update != false ) {?>
		<div id="message" class="updated fade"><p><strong><?php echo wp_kses( $did_update, 'post' ); ?></strong></p></div><?php
	}
...
function wpmem_a_warning_msg( $msg ) {
	...
	if ( $span_msg ) {
		$span_msg = ' [<span data-tooltip="' . esc_attr( $span_msg ) . '">why is this?</span>]';
	}
	
	return '<li><strong>' . esc_html( $strong_msg ) . '</strong> ' . wp_kses( $remain_msg, wp_kses_allowed_html( 'post' ) ) . $span_msg . '</li>';
...
function wpmem_a_meta_box() {
	...
	?><div class="postbox">
		...
		<div class="inside">
			...
			<p><strong><?php esc_html_e( 'Version:', 'wp-members' ); echo "&nbsp;" . esc_html( $wpmem->version ); ?></strong><br />
				<a href="https://rocketgeek.com/plugins/wp-members/quick-start-guide/"><?php esc_html_e( 'Quick Start Guide', 'wp-members' ); ?></a><br />
				<a href="https://rocketgeek.com/plugins/wp-members/docs/"><?php esc_html_e( 'Online User Guide', 'wp-members' ); ?></a><br />
				<a href="https://rocketgeek.com/plugins/wp-members/docs/faqs/"><?php esc_html_e( 'FAQs', 'wp-members' ); ?></a>
...
function wpmem_a_rss_box() {
	...
	?><div class="postbox">
		<h3><span><?php esc_html_e( 'Latest from RocketGeek', 'wp-members' ); ?></span></h3>
 ...
 *
 * @since 2.8.0
 * @since 3.5.7 Changed function name from butlerblog_dashboard_widget to wpmem_dashboard_widget.
 */
function wpmem_dashboard_widget() {
	wp_add_dashboard_widget( 'dashboard_custom_feed', esc_html__( 'Latest from ButlerBlog', 'wp-members' ), 'wpmem_feed_output' );
}
 ...
 *
 * @since 2.8.0
 * @since 3.5.7 Changed function name from butlerblog_feed_output to wpmem_feed_output.
 */
function wpmem_feed_output() {
